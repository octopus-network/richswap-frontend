...
function TradeRow({
  ...
  const runePriceInSats = new Decimal(btcAmount)
    .div(formattedRuneAmount)
    .toNumber();
...
export default function MyTradesContent({ rune }: { rune: string }) {
  ...
  return (
    <TabsContent value="myTrades" className="px-4 pb-4">
